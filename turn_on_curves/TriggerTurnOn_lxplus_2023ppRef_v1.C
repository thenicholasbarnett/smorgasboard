...
// executed code 
void TriggerTurnOn_lxplus_2023ppRef_v1(TString output = "turnon_2023ppRef_11_9_2024.root"){
    ...
    // ifstream myfile("/afs/cern.ch/user/n/nbarnett/public/txt_files/filename_txt_files/2023ppRef_zerobias_filenames/2023ppRef_zerobias_all_filenames.txt");
    ifstream myfile("/afs/cern.ch/user/n/nbarnett/public/txt_files/filename_txt_files/2023ppRef_zerobias_filenames/2023ppRef_zerobias1_filenames_2files.txt");
    string filename;
