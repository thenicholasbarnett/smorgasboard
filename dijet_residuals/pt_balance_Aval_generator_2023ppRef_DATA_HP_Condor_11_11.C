...
void pt_balance_Aval_generator_2023ppRef_DATA_HP_Condor_11_11(TString input, TString output)
{   
        ...
        if(TMath::Abs(vz)<15){
            ...
            if((pPVF==1)&&(jet_trigger==1)){
                ...
                if(nref>2){
                    ...
                    if((TMath::ACos(TMath::Cos(jtphi[leaditer]-jtphi[subleaditer]))>2.7)&&(jtcorrpt[subleaditer]>ptcut)&&((TMath::Abs(jteta[leaditer])<1.3)||(TMath::Abs(jteta[subleaditer])<1.3))){
                        if(TMath::Abs(jteta[leaditer])<1.3){
                            tagiter = leaditer;
                            probeiter = subleaditer;
                        }
                        ...
                        // removing outlier A valuesoutsid of -0.7 to 0.7
                            ...
                            if(((alphas[a]/2)*(jtcorrpt[probeiter]+jtcorrpt[tagiter]))>jtcorrpt[thirditer]){
                                ...
                                for(unsigned int p=0; p<ptslicenum; p++){
                                    ...
                                    if((ptavg>ptlow[p])&&(ptavg<pthigh[p])){
                                        ...
                                        ptslicesA[a][p]->Fill(TMath::Abs(jteta[probeiter]),Aval);
                                    }
                                }
                                ...
                                for(unsigned int q=0; q<etaslicenum; q++){
                                    ...
                                    if((TMath::Abs(jteta[probeiter])>etalow[q])&&(TMath::Abs(jteta[probeiter])<etahigh[q])){
