...
void pt_balance_Aval_generator_2023ppRef_MC_ZB_Condor_10_15(TString input, TString output)
{   
...
// INITIALIZING ARRAYS //
    ...
    double ptlow[ptslicenum] = {15,25,55,80};
    double pthigh[ptslicenum] = {25,55,80,1000};
