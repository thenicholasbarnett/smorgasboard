...
// executed code 
void TriggerTurnOn_lxplus_2024ppRef_v1(TString output = "turnon_2024ppRef_11_9_2024.root"){
    ...
    // ifstream myfile("/afs/cern.ch/user/n/nbarnett/public/txt_files/filename_txt_files/2024ppRef_zerobias_filenames/2024ppRef_DATA_RunningTotal_filenames.txt");
    ifstream myfile("/afs/cern.ch/user/n/nbarnett/public/txt_files/filename_txt_files/2024ppRef_zerobias_filenames/2024ppRef_DATA_ZBForward1_387607_2_filenames.txt");
    string filename;
    ...
    while(getline(myfile, filename)){
        ...
        // jet hlt hits
        hlt_tree->SetBranchStatus("HLT_AK4PFJet40_v8", 1);
        hlt_tree->SetBranchStatus("HLT_AK4PFJet60_v8", 1);
        hlt_tree->SetBranchStatus("HLT_AK4PFJet80_v8", 1);
        hlt_tree->SetBranchStatus("HLT_AK4PFJet100_v8", 1);
        hlt_tree->SetBranchStatus("HLT_AK4PFJet120_v8", 1);
        // zb hlt hits
        hlt_tree->SetBranchStatus("HLT_PPRefZeroBias_v6", 1);
        // jet momenta
        ...
        // turning tree branches of interest on
        // jet hlts
        hlt_tree->SetBranchAddress("HLT_AK4PFJet40_v8", &hlt_40);
        hlt_tree->SetBranchAddress("HLT_AK4PFJet60_v8", &hlt_60);
        hlt_tree->SetBranchAddress("HLT_AK4PFJet80_v8", &hlt_80);
        hlt_tree->SetBranchAddress("HLT_AK4PFJet100_v8", &hlt_100);
        hlt_tree->SetBranchAddress("HLT_AK4PFJet120_v8", &hlt_120);
        // zb hlt hit
        hlt_tree->SetBranchAddress("HLT_PPRefZeroBias_v6", &hlt_zb);
        // jet momenta
    ...
    cout<<njets_<<" is the number of leading jets passed the pvf"<<endl;
